...
const adminStatsController = {
    ...
    getAllAdminStats: async (req, res) => {
        try {
    ...
    getTotalChapters: async (req, res) => {
        try {
            const totalChapters = await prisma.chapter.count();
    ...
    getLessonCompletionRate: async (req, res) => {
        try {
            const completedLessons = await prisma.practiceSession.count({
                where: {
                    finishedAt: { not: null },
    ...
    getAverageExamScore: async (req, res) => {
        try {
            const examResults = await prisma.examResult.findMany({
                where: {
                    finishedAt: { not: null },
    ...
    getTotalQuestionsAnswered: async (req, res) => {
        try {
    ...
    getLessonCompletionBreakdown: async (req, res) => {
        try {
    ...
    getPerformanceByTopic: async (req, res) => {
        try {
            const { fromDate, toDate } = req.query;
            // Build date filter if provided
            let dateFilter = {};
