...
const examController = {
    ...
    getAllExams: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error getting exams', error: error.message });
        }
    },
    ...
    getExamById: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error getting exam', error: error.message });
        }
    },
    // Get exams by grade
    getExamsByGrade: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error getting exams by grade', error: error.message });
        }
    },
    // Get exams by chapter
    getExamsByChapter: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error getting exams by chapter', error: error.message });
        }
    },
    // Get exam results for a specific user
    getExamResultsByUser: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error getting exam results', error: error.message });
        }
    },
    // Get all exam results by exam ID
    getExamResultsByExamId: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error getting exam results by exam ID', error: error.message });
        }
    },
    // Get a specific exam result by ID
    getExamResultById: async (req, res) => {
        try {
            const { id } = req.params;
            ...
            res.status(500).json({ message: 'Error getting exam result', error: error.message });
        }
    },
    ...
    saveExamAnswer: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error saving exam answer', error: error.message });
        }
    },
    ...
    finishExam: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error finishing exam', error: error.message });
        }
    },
    ...
    getExamProgress: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error getting exam progress', error: error.message });
        }
    },
    // Get active exam for a user
    getActiveExamForUser: async (req, res) => {
        try {
            const { userId } = req.params;
            ...
            res.status(500).json({ message: 'Error getting active exam', error: error.message });
        }
    },
    // Create a new exam
    ...
    addQuestionToExam: async (req, res) => {
        try {
    ...
    addMultipleQuestionsToExam: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error adding multiple questions to exam', error: error.message });
        }
    },
    ...
    removeQuestionFromExamLegacy: async (req, res) => {
        try {
            const { id } = req.params;
