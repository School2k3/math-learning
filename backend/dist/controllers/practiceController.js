...
const practiceController = {
    ...
    createOrUpdateSession: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error creating/updating practice session', error: error.message });
        }
    },
    ...
    saveAnswer: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error saving practice answer', error: error.message });
        }
    },
    ...
    completeSession: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error completing practice session', error: error.message });
        }
    },
    // Get practice history for a user
    getUserPracticeHistory: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error getting practice history', error: error.message });
        }
    },
    ...
    getCurrentScore: async (req, res) => {
        try {
            ...
            res.status(500).json({ message: 'Error getting practice score', error: error.message });
        }
    }
};
