...
import { sendBadRequestResponse, sendSuccessResponse, sendUnauthorizedResponse, sendErrorResponse } from '../utils/apiResponse.js';
...
export const register = async (req, res) => {
    try {
        ...
        sendSuccessResponse(res, userWithoutPassword, 'User registered successfully. Please verify your email with the OTP sent to your email.', 201);
    }
    catch (error) {
