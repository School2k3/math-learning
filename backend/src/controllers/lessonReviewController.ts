...
const lessonReviewController: Controller = {
  // Like a lesson
  likeLesson: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error liking lesson', error: (error as Error).message });
    }
  },
  
  // Unlike a lesson
  unlikeLesson: async (req: Request, res: Response): Promise<void> => {
    try {
      const { userId, lessonId } = req.body;
      ...
      res.status(500).json({ message: 'Error unliking lesson', error: (error as Error).message });
    }
  },
  
  // Get lesson likes count and users who liked
  getLessonLikes: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error getting lesson likes', error: (error as Error).message });
    }
  },
  
  // Create or update a review
  createOrUpdateReview: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error creating/updating review', error: (error as Error).message });
    }
  },
  ...
  getLessonReviews: async (req: Request, res: Response): Promise<void> => {
    try {
      const { lessonId } = req.params;
      ...
      res.status(500).json({ message: 'Error getting lesson reviews', error: (error as Error).message });
    }
  },
  
  // Get a specific user's review for a lesson
  getUserReview: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error getting user review', error: (error as Error).message });
    }
  },
};
