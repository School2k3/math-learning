...
const UserAdmin: React.FC = () => {
  ...
  const mockUsers: User[] = [
    {
      user_id: 1,
      username: "duong123",
      password_hash: "$2b$10$jqGEanCw6...",
      email: "duongdtth17jkt@gmail.com",
      full_name: "Duong Nguyen Van",
      role: "student",
      grade: 1,
      avatar_url: null,
      created_at: "2025-09-29 13:02:01.804",
      updated_at: "2025-09-29 13:03:06.938",
      is_verified: true
    },
    {
      user_id: 2,
      username: "johndoe",
      password_hash: "$2b$10$wyrmT0CC...",
      email: "john@example.com",
      full_name: "John Doe",
      role: "student",
      grade: 3,
      avatar_url: null,
      created_at: "2025-10-01 14:03:52.301",
      updated_at: "2025-10-01 14:03:52.301",
      is_verified: false
    },
    {
      user_id: 3,
      username: "truong123",
      password_hash: "$2b$10$H1qGS9Co3@...",
      email: "truong9043@gmail.com",
      full_name: "Truong Ngo",
      role: "student",
      grade: 1,
      avatar_url: null,
      created_at: "2025-10-01 15:06:57.85",
      updated_at: "2025-10-01 15:07:56.952",
      is_verified: true
    },
    {
      user_id: 4,
      username: "bndon",
      password_hash: "132434",
      email: "sad cd",
      full_name: "dsfsdf",
      role: "student",
      grade: 1,
      avatar_url: null,
      created_at: "2025-09-19 08:05:12.598",
      updated_at: "2025-09-19 15:05:11",
      is_verified: false
    },
    {
      user_id: 6,
  ...
  const filteredUsers = users.filter(user => {
    ...
    if (filterGrade !== "all" && user.grade !== Number(filterGrade)) return false;
  ...
  const handleSave = () => {
    ...
    const updatedUsers = users.map(user => 
      user.user_id === editingId 
        ? { ...user, ...editData, updated_at: new Date().toISOString().replace('T', ' ').slice(0, 19) }
        : user
    );
    ...
    <div className="admin-dashboard">
      ...
      <div className="admin-main">
        ...
        <div className="filter-section" style={{ 
          ...
          <div>
            <label style={{ display: "block", marginBottom: "4px", fontWeight: "500" }}>Tìm kiếm:</label>
            <input
              type="text"
              value={searchTerm}
          ...
          <div>
            <label style={{ display: "block", marginBottom: "4px", fontWeight: "500" }}>Lớp:</label>
            <select 
              value={filterGrade} 
          ...
          <div>
            <label style={{ display: "block", marginBottom: "4px", fontWeight: "500" }}>Xác thực:</label>
            <select 
            ...
            <tbody>
              ...
              {showAddForm && (
                <tr className="add-row">
                  <td>-</td>
                  <td>
                    <div style={{ width: "40px", height: "40px", backgroundColor: "#ddd", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      👤
                    </div>
                  </td>
                  <td>
                  ...
                  <td>
                    <span className="status-badge unverified">Chưa xác thực</span>
                  </td>
                  <td>-</td>
                  <td>
                ...
                <tr key={user.user_id}>
                  ...
                  <td>
                    {editingId === user.user_id ? (
                      <select
                        value={editData.role || ""}
                        onChange={(e) => setEditData({...editData, role: e.target.value as 'student' | 'teacher' | 'admin'})}
                        className="select-field"
                      >
                        <option value="student">Học sinh</option>
                        <option value="teacher">Giáo viên</option>
                  ...
                  <td>
                    {editingId === user.user_id ? (
                      ...
                      <div className="action-buttons">
                        ...
                        <button className="btn-delete" onClick={() => handleDelete(user.user_id)}>
                          🗑️
                        </button>
                      </div>
                    )}
