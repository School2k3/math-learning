...
const rewardController: Controller = {
  // Get all available rewards (avatars)
  getAllRewards: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error getting rewards', error: (error as Error).message });
    }
  },
  ...
  getRewardById: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error getting reward', error: (error as Error).message });
    }
  },
  ...
  getUserRewards: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error getting user rewards', error: (error as Error).message });
    }
  },
  
  // Exchange trophies for a reward (avatar)
  exchangeReward: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error exchanging reward', error: (error as Error).message });
    }
  },
  
  // Equip an avatar (set as current avatar)
  equipAvatar: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error equipping avatar', error: (error as Error).message });
    }
  },
  ...
  createReward: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error creating reward', error: (error as Error).message });
    }
  },
  ...
  updateReward: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error updating reward', error: (error as Error).message });
    }
  },
  ...
  deleteReward: async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      res.status(500).json({ message: 'Error deleting reward', error: (error as Error).message });
    }
  },
};
